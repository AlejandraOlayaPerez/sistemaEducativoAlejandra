...
<html>
<head>
<link src="css/estilo.css"></link>
</head>

<body background="fondo.jpg">
<div class="container">
<h1>NUEVO ESTUDIANTE</h1>
<form action="../CRUD_estudiante/crearEstudiante.php" method="GET">
<div class="row">
    <div class="col col-6">
...
<a href="http://localhost/phpCRUD/CRUD_estudiante/listarEstudiante.php" class="btn btn-dark"><i class="fas fa-arrow-circle-left"></i> Atras</a>
</div>
</form>
</body>
</html>
