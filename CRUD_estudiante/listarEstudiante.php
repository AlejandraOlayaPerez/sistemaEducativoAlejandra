...
<html>
    ...
    <body>
        ...
        <tr>
            ...
            <th>Dirección</th>
            <th>Telefono</th>
            <th><a class="btn btn-info" href="../CRUD_estudiante/nuevoEstudiante.php"><i class="fas fa-user-plus"></i> Nuevo</a></th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        foreach($Consulta as $registro){
            ...
            <tr>
                ...
                <td>
                    <a href="http://localhost/phpCRUD/CRUD_estudiante/formularioEditar.php?id=<?php echo $registro['id']; ?>" class="btn btn-warning"><i class="fas fa-user-edit"></i> Editar</a>
                    ...
                    <a href="http://localhost/phpCRUD/CRUD_estudiante/detalleEstudiante.php?id=<?php echo $registro['id']; ?>" class="btn btn-light"><i class="fas fa-address-card"></i> Detalle</a>
                </td>
...
<div class="modal fade" id="eliminarFormulario" tabindex="-1" aria-labelledby="Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../CRUD_estudiante/eliminarEstudiante.php" method="GET">
